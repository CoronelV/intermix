            ...
            <nav class="bg-slate-800 text-white px-8 py-4">
                <div class="container mx-auto flex items-center justify-between ">
                    ...
                    <div class="flex items-center">
                        <input type="text" placeholder="Buscar..." class="rounded-l-lg px-4 py-2 focus:outline-none text-black" />
                    ...
                    <div class="relative">
                        <Link to="/carrito">
                            <span class="bg-red-600 text-white absolute top-0 right-0 w-5 h-5 text-center rounded-full text-sm">{props.carrito.length}</span>
